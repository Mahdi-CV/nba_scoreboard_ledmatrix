        ...
        for game in games_data:
            ...
            if game_status == 2:
                ...
                for period in range(1, game['regulationPeriods'] + 1):
                    ...
                    graphics.DrawText(canvas, self.font2, score_x, 24, graphics.Color(255, 255, 255), str(away_score))
                    graphics.DrawText(canvas, self.font2, score_x, 32, graphics.Color(255, 255, 255), str(home_score))
